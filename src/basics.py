...
class BasicTests(unittest.TestCase):
    ...
    def test_doccount(self):
        db_name = self._get_db_name()
        self.server.create(db_name)
        tools.ok_(self.server[db_name].info()['doc_count'] == 0)
    ...
    def test_multipledocs(self):
        ...
        tools.ok_(self.server[db_name].info()['doc_count'] == len(docs))
    ...
    def test_maponekey(self):
        ...
        tools.eq_(results.rows[0].value, doc1["b"])
        print results
    ...
    def test_reduceonekey(self):
        ...
        tools.eq_(results.total_rows, 1)
        tools.eq_(results.rows[0].value, doc1["b"] + doc3["b"])
